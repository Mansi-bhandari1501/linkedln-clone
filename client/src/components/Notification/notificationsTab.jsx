...
useEffect(() => {
    ...
    return (
        ...
        onClick={handleClickbtn} sx={{
            height: "116px"
        }}>
            <Stack sx={{ flexDirection: "row", paddingLeft: "30px", paddingTop: "16px",paddingBottom: "16px" }}>
                <Avatar></Avatar>
                <Stack sx={{ gap: "10px", marginLeft: "10px" }}>
                    <Typography
                        ...
                        hihiihigvdfgdfghfdbngnbfgbnfnfdnf dhbsdfhb  tergebgfbsfkjbn kdfffffffffbhkdjshbkdfjhdkjhbkdbk
                    </Typography>
                    <Typography
                        sx={{
                            fontSize: "14px",
